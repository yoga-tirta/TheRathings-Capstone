...
const API_ENDPOINT = {
  FOOD_POPULARITY: (offset) => `${CONFIG.BASE_URL}recipes/complexSearch?sort=popularity&addRecipeNutrition=true&addRecipeInformation=true&number=24&offset=${offset}&${CONFIG.API_KEY}`,
